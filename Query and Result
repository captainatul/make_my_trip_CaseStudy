...
-- write a query to write date difference between first and last booking for each user
...
--write a query to count the number of flight and hotel bookings for each of the user segment for the year 2022
